...
namespace Tower_Dungeon {
    ...
    public partial class masterDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string fName, string lName, string email, string password, string username, bool isAdmin) {
...
namespace Tower_Dungeon.masterDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Users] WHERE (([id] = @Original_id) AND ([fName] = @Original_fName) AND ([lName] = @Original_lName) AND ([email] = @Original_email) AND ([password] = @Original_password) AND ([username] = @Original_username) AND ([isAdmin] = @Original_isAdmin))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([fName], [lName], [email], [password], [username], [is" +
                "Admin]) VALUES (@fName, @lName, @email, @password, @username, @isAdmin);\r\nSELECT" +
                " id, fName, lName, email, password, username, isAdmin FROM Users WHERE (id = SCO" +
                "PE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [fName] = @fName, [lName] = @lName, [email] = @email, [password] = @password, [username] = @username, [isAdmin] = @isAdmin WHERE (([id] = @Original_id) AND ([fName] = @Original_fName) AND ([lName] = @Original_lName) AND ([email] = @Original_email) AND ([password] = @Original_password) AND ([username] = @Original_username) AND ([isAdmin] = @Original_isAdmin));
SELECT id, fName, lName, email, password, username, isAdmin FROM Users WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Tower_Dungeon.Properties.Settings.Default.masterConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, fName, lName, email, password, username, isAdmin FROM dbo.Users";
        ...
        public virtual int Delete(int Original_id, string Original_fName, string Original_lName, string Original_email, string Original_password, string Original_username, bool Original_isAdmin) {
        ...
        public virtual int Insert(string fName, string lName, string email, string password, string username, bool isAdmin) {
            if ((fName == null)) {
        ...
        public virtual int Update(string fName, string lName, string email, string password, string username, bool isAdmin, int Original_id, string Original_fName, string Original_lName, string Original_email, string Original_password, string Original_username, bool Original_isAdmin, int id) {
            if ((fName == null)) {
                throw new global::System.ArgumentNullException("fName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fName, string lName, string email, string password, string username, bool isAdmin, int Original_id, string Original_fName, string Original_lName, string Original_email, string Original_password, string Original_username, bool Original_isAdmin) {
            return this.Update(fName, lName, email, password, username, isAdmin, Original_id, Original_fName, Original_lName, Original_email, Original_password, Original_username, Original_isAdmin, Original_id);
        }
    }
